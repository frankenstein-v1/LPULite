...
module lpu_sxm_pure_tb;
    ...
    task automatic load_inst(
        ...
        begin
            ...
            word[28:14] = mem0_addr;
            word[29]    = mem1_read_en;
            word[30]    = mem1_write_en;
            word[45:31] = mem1_addr;
            word[47:46] = mxm_ingress_mode;
            word[48]    = mxm_start;
            word[49]    = mxm_clear;
            word[52:50] = mxm_e_row_sel;
            word[55:53] = mxm_e_col_sel;
            word[56]    = mxm_e_valid_in;
            word[63]    = (sxm_opcode_input == 12'h5A5);
            word[64]    = (sxm_opcode_input == 12'hA5A);
            word[65]    = (sxm_opcode_input == 12'h5A5) && (westbound_consumer_sel == 3'd2);
            word[69:66] = vxm_ctrl;
            word[70]    = vxm_data_sel;
