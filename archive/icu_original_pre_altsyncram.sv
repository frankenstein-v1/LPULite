// Archive copy of src/icu.sv before the DE1-SoC HPS FPGA build switched
// IMEM to explicit Intel altsyncram block RAM.
module icu #(
...
`endif
    ...
    // A simple register that tracks what line of code is on.
    logic [31:0] pc;
